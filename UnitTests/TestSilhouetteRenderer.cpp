...
//	SilhouetteEnergy silhouette_energy(generator, projector);
//
...
//	Silhouette input = silhouette_energy.Infer(input_translation, input_betas, input_thetas);
//
...
//		DirectXProjection(IMAGE_WIDTH, IMAGE_HEIGHT);
//
//	Generator generator(Generator::Configuration(std::string("../Model")));
